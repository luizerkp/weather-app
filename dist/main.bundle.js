...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/RubikSprayPaint-Regular.ttf */ "./src/fonts/RubikSprayPaint-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/default.webp */ "./src/imgs/default.webp"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face {\n  font-family: 'RibikSprayPaintRegular';\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n}\n\nbody {\n    padding: 0;\n    min-height: 100vh;\n    display: flex;\n    flex-direction: column;\n    background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n    background-position: center;\n    background-repeat: no-repeat;\n    background-size: cover;\n    color: white;\n    font-style: 'RibikSprayPaintRegular';\n    /* font-family: 'Segoe UI', 'Open Sans', 'Helvetica Neue', sans-serif; */\n} \n\n.header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin: 1rem;\n  padding: 1rem;\n}\n\n.logo-div {\n  display: flex;\n  gap: 10px;\n  justify-content: center;\n  align-items: center;\n}\n\n.logo {\n  height: 44px;\n}\n\n.hidden {\n  opacity: 0;\n  height: 0;\n}\n\n#search-form {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 10px;\n}\n\n#search-bar {\n  border: none;\n  outline: none;\n  font-size: 1rem;\n  border-radius: .5rem;\n  font-weight: bold;\n  background: rgba(255, 255, 255, 0.2);\n  color: white;\n  padding: 1rem;\n}\n\n#search-bar::placeholder {\n  color: rgba(255, 255, 255, 0.8);;\n}\n\n#search-btn {\n  border-radius: .5rem;\n  background-image: linear-gradient(-135deg, rgb(255, 0, 144) 20%, rgb(153, 51, 255) 100%);\n}\n#search-icon {\n  font-size: 2.5rem;\n  color: white;\n}\n\n#main-container {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex: 1 0 auto;\n}\n\nul {\n  list-style: none;\n}\n\n.unit-select {\n  display: flex;\n  gap: 20px;\n  font-size: 1.5rem;\n}\n\n.unit-select label {\n  font-weight:bolder;\n  font-family: 'RubikSprayPaintRegular', 'Segoe UI', 'Open Sans', sans-serif;\n}\n\n/* Sticky Footer and credit */\n.footer {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-shrink: 0;\n    height: 50px;\n    gap: 8px;\n    font-weight: bold;\n    color: white;\n    /* background-color: #d8dee2; */\n}\n\n#github-logo {\n    padding-left: 8px;\n    padding-right: 8px;\n}\n\n/* ########################################## Responsive layout ########################################################*/\n/* @media only screen and (max-width: 1200px) {\n\n}\n\n@media only screen and (max-width: 650px) {\n\n}\n\n@media only screen and (max-width: 500px) {\n\n    #github-logo>img {\n        height: 20px;\n        width: 20px;\n    }\n}\n\n @media only screen and (max-width: 325px) {\n\n    .footer>p {\n        font-size: 14px;\n        margin: 8px;\n    }\n } */\nhtml {\n  display: block;\n}", "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;EACE,qCAAqC;EACrC,4CAAgD;AAClD;;AAEA;IACI,UAAU;IACV,iBAAiB;IACjB,aAAa;IACb,sBAAsB;IACtB,yDAA6C;IAC7C,2BAA2B;IAC3B,4BAA4B;IAC5B,sBAAsB;IACtB,YAAY;IACZ,oCAAoC;IACpC,wEAAwE;AAC5E;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,aAAa;EACb,SAAS;EACT,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,UAAU;EACV,SAAS;AACX;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,eAAe;EACf,oBAAoB;EACpB,iBAAiB;EACjB,oCAAoC;EACpC,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,+BAA+B;AACjC;;AAEA;EACE,oBAAoB;EACpB,wFAAwF;AAC1F;AACA;EACE,iBAAiB;EACjB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,cAAc;AAChB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,SAAS;EACT,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,0EAA0E;AAC5E;;AAEA,6BAA6B;AAC7B;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,cAAc;IACd,YAAY;IACZ,QAAQ;IACR,iBAAiB;IACjB,YAAY;IACZ,+BAA+B;AACnC;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;AACtB;;AAEA,yHAAyH;AACzH;;;;;;;;;;;;;;;;;;;;;;IAsBI;AACJ;EACE,cAAc;AAChB","sourcesContent":["@font-face {\n  font-family: 'RibikSprayPaintRegular';\n  src: url('../fonts/RubikSprayPaint-Regular.ttf');\n}\n\nbody {\n    padding: 0;\n    min-height: 100vh;\n    display: flex;\n    flex-direction: column;\n    background-image: url('../imgs/default.webp');\n    background-position: center;\n    background-repeat: no-repeat;\n    background-size: cover;\n    color: white;\n    font-style: 'RibikSprayPaintRegular';\n    /* font-family: 'Segoe UI', 'Open Sans', 'Helvetica Neue', sans-serif; */\n} \n\n.header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin: 1rem;\n  padding: 1rem;\n}\n\n.logo-div {\n  display: flex;\n  gap: 10px;\n  justify-content: center;\n  align-items: center;\n}\n\n.logo {\n  height: 44px;\n}\n\n.hidden {\n  opacity: 0;\n  height: 0;\n}\n\n#search-form {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 10px;\n}\n\n#search-bar {\n  border: none;\n  outline: none;\n  font-size: 1rem;\n  border-radius: .5rem;\n  font-weight: bold;\n  background: rgba(255, 255, 255, 0.2);\n  color: white;\n  padding: 1rem;\n}\n\n#search-bar::placeholder {\n  color: rgba(255, 255, 255, 0.8);;\n}\n\n#search-btn {\n  border-radius: .5rem;\n  background-image: linear-gradient(-135deg, rgb(255, 0, 144) 20%, rgb(153, 51, 255) 100%);\n}\n#search-icon {\n  font-size: 2.5rem;\n  color: white;\n}\n\n#main-container {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex: 1 0 auto;\n}\n\nul {\n  list-style: none;\n}\n\n.unit-select {\n  display: flex;\n  gap: 20px;\n  font-size: 1.5rem;\n}\n\n.unit-select label {\n  font-weight:bolder;\n  font-family: 'RubikSprayPaintRegular', 'Segoe UI', 'Open Sans', sans-serif;\n}\n\n/* Sticky Footer and credit */\n.footer {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex-shrink: 0;\n    height: 50px;\n    gap: 8px;\n    font-weight: bold;\n    color: white;\n    /* background-color: #d8dee2; */\n}\n\n#github-logo {\n    padding-left: 8px;\n    padding-right: 8px;\n}\n\n/* ########################################## Responsive layout ########################################################*/\n/* @media only screen and (max-width: 1200px) {\n\n}\n\n@media only screen and (max-width: 650px) {\n\n}\n\n@media only screen and (max-width: 500px) {\n\n    #github-logo>img {\n        height: 20px;\n        width: 20px;\n    }\n}\n\n @media only screen and (max-width: 325px) {\n\n    .footer>p {\n        font-size: 14px;\n        margin: 8px;\n    }\n } */\nhtml {\n  display: block;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
module.exports = __webpack_require__.p + "ec53b8e7534af68084d2.ttf";
...
/* harmony import */ var _fonts_RubikSprayPaint_Regular_ttf__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fonts/RubikSprayPaint-Regular.ttf */ "./src/fonts/RubikSprayPaint-Regular.ttf");
...
const getFiveDayForcast = async (lat, lon) => {
  let fiveDayForcast;
  try {
    fiveDayForcast = await _apiRequests__WEBPACK_IMPORTED_MODULE_5__.weatherInfoAPIRequest.fetchFiveDayForcast(lat, lon);
  } catch (error) {
...
const getCurrentWeather = async (lat, lon) => {
  ...
  // console.log(city);
  try {
    currentLocalWeather = await _apiRequests__WEBPACK_IMPORTED_MODULE_5__.weatherInfoAPIRequest.fetchCurrentWeather(lat, lon);
  } catch (error) {
    return handleError(error);
  }
...
const getCityGeocodeInfo = async (searchTerm) => {
  let city;
  try {
    city = await _apiRequests__WEBPACK_IMPORTED_MODULE_5__.geocodingAPIRequest.fetchGeocoding(searchTerm);
  } catch (error) {
    console.log(error.message);
    return handleError(error);
  }
...
const getCityWeatherInfo = async (searchTerm) => {
  ...
  return _displayWeatherData__WEBPACK_IMPORTED_MODULE_6__["default"].displayWeather(city, currentWeather, fiveDayWatherForcastData);
};
...
const unitSelectionEventHandler = () => {
  ...
  // ensures only one radio btn can checked
  const radioClickHandler = (event, radioOne, radioTwo) => {
    if (event.target.id === radioOne.id) {
  ...
  fahrenheitRadio.addEventListener("click", (event) => {
    radioClickHandler(event, fahrenheitRadio, celciusRadio);
  });

  celciusRadio.addEventListener("click", (event) => {
    radioClickHandler(event, fahrenheitRadio, celciusRadio);
  });
};
